...
monthly_rentals = filtered_data.groupby('mnth', as_index=False)['cnt'].sum()
...
if 'hr' in filtered_data.columns:
    hourly_rentals = filtered_data.groupby('hr', as_index=False)['cnt'].mean()
...
weather_rentals = filtered_data.groupby('weathersit', as_index=False)['cnt'].mean()
